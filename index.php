...
<section style="padding: 0 1rem;">
    <div style="max-width: 1280px; margin: 2rem auto;">
        <div style="min-height: 520px; display: flex; flex-direction: column; justify-content: center; padding: 3rem; border-radius: 1rem; 
                    background: linear-gradient(90deg, rgba(247, 248, 246, 0.9) 0%, rgba(247, 248, 246, 0) 60%), 
            ...
            <div style="max-width: 600px;">
                <h1 style="font-size: 3rem; font-weight: 900; line-height: 1.1; color: var(--text-light);">
                    Rau Sạch Tận Nhà,<br>Cho Bữa Cơm Lành
                </h1>
                <p style="margin-top: 1rem; font-size: 1.125rem; color: var(--muted-light);">
                    Khám phá rau củ quả 100% hữu cơ, được nuôi trồng bền vững từ các nông trại địa phương.
                </p>
                <a href="<?= SITE_URL ?>/products.php" class="btn btn-primary" style="margin-top: 2rem;">
                    Mua sắm ngay
                </a>
            </div>
        </div>
    ...
    <div style="max-width: 1280px; margin: 0 auto;">
        ...
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 1.5rem;">
            ...
            <a href="<?= SITE_URL ?>/products.php?category=<?= $cat['id'] ?>" 
               style="position: relative; aspect-ratio: 1; border-radius: 0.75rem; overflow: hidden; display: block;">
