                ...
                <div style="display: flex; flex-direction: column; gap: 2rem;">
                    ...
                    <div style="display: flex; gap: 1rem;">
                        ...
                        <div>
                            ...
                            <p style="color: var(--muted-light);">
                                Hotline: <a href="tel:1900123456" style="color: var(--primary-dark); font-weight: 600;">1900 123 456</a><br>
                    ...
                    <div style="display: flex; gap: 1rem;">
                        ...
                        <div>
                            ...
                            <p style="color: var(--muted-light);">
                                <a href="mailto:info@xanhorganic.vn" style="color: var(--primary-dark); font-weight: 600;">info@xanhorganic.vn</a><br>
                                <a href="mailto:support@xanhorganic.vn" style="color: var(--primary-dark); font-weight: 600;">support@xanhorganic.vn</a>
                            </p>
                        </div>
                    </div>
                    ...
                    <div style="display: flex; gap: 1rem;">
                        ...
                        <div>
                            ...
                            <div style="display: flex; gap: 1rem; margin-top: 0.75rem;">
                                <a href="#" style="width: 40px; height: 40px; border-radius: 50%; background: #1877f2; display: flex; align-items: center; justify-content: center; color: white;">
                                    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                    </svg>
                                </a>
                                <a href="#" style="width: 40px; height: 40px; border-radius: 50%; background: #E4405F; display: flex; align-items: center; justify-content: center; color: white;">
                                    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="#" style="width: 40px; height: 40px; border-radius: 50%; background: #0088cc; display: flex; align-items: center; justify-content: center; color: white;">
                                    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
