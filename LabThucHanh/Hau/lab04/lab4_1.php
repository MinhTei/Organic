...
//         $b[] = 7;
//         $c['d'] = 8;
//         echo "<hr> Sau khi thêm phần tử, nội dung các mảng  là :<br/>";
//         print_r($a);
//         print_r($b);
//         print_r($c);
...
//         unset($b[$x]);
//         unset($c['a']);
//         echo "<hr> Sau khi xóa phần tử, nội dung các mảng  là :<br/>";
//         print_r($a);
//         print_r($b);
//         print_r($c);
...
//         print_r($c);
        ...
        //Tìm phần tử tồn tại trong mảng, xóa hoặc thay thế 
        ...
        if (in_array($element, $array)) {
         // Tìm chỉ mục của phần tử trong mảng
            ...
            $array[$key] = 10; 
            // unset($array[$key]); // Nếu muốn xóa phần tử
            echo "Mảng sau khi thay thế phần tử $element là:";
            print_r($array);
        } else {
