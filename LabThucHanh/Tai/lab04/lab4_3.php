...
// Sắp xếp mảng a giảm dần (loại bỏ key)
$a11 = $a;
rsort($a11);
echo "<br/>Mảng a sau khi sắp xếp giảm dần (loại bỏ key):";
showArray($a11);

// Sắp xếp mảng b giảm dần (loại bỏ key)
$b11 = $b;
rsort($b11);
echo "<br>Mảng b sau khi sắp xếp giảm dần (loại bỏ key):";
showArray($b11);

// Sắp xếp mảng b giảm dần (giữ lại key)
$b22 = $b;
arsort($b22);
echo "<br>Mảng b sau khi sắp xếp giảm dần (giữ lại key):";
showArray($b2);

// Sắp xếp mảng b theo key giảm dần
$b3 = $b;
krsort($b3);
echo "<br>Mảng b sau khi sắp xếp theo key giảm dần:";
showArray($b3);
