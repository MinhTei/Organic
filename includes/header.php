        ...
        <div class="header-container">
            ...
            <div class="header-row-1">
                ...
                <div class="right-icons">
                    ...
                    <?php if ($isLoggedIn): ?>
                        <a href="<?= SITE_URL ?>/wishlist.php" class="icon-btn wishlist-btn" id="wishlistHeaderBtn" style="position: relative;">
                            <span class="material-symbols-outlined">favorite</span>
                            <span class="wishlist-count-badge" style="position: absolute; top: -4px; right: -4px; background: var(--primary); color: #000; font-size: 0.75rem; font-weight: 700; width: 20px; height: 20px; border-radius: 50%; display: none; align-items: center; justify-content: center;"></span>
                        </a>
                    <?php else: ?>
                        <a href="<?= SITE_URL ?>/auth.php" class="icon-btn wishlist-btn" id="wishlistHeaderBtn">
                            <span class="material-symbols-outlined">favorite</span>
                        </a>
                    <?php endif; ?>
            ...
            <div class="header-actions">
                ...
                <?php else: ?>
                    <a href="<?= SITE_URL ?>/auth.php" class="icon-btn wishlist-btn" id="wishlistHeaderBtnDesktop">
                        <span class="material-symbols-outlined">favorite</span>
                    </a>
                <?php endif; ?>
